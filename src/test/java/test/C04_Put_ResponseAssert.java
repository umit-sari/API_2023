 ...
 */
    ...
    Response response=given().contentType(ContentType.JSON) // json tipinde veri veriyoruz
            .when()
            .body(reqBody.toString()) // listeyi stringe cevirip
            .put(url); // url 'e gonderiyoruz
